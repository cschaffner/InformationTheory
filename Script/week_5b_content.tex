...
A (undirected simple) graph $G$ consists of a set $V(G)$ of \term{vertices} and a set $E(G)$ of \term{edges}. The edges are unordered pairs of vertices (each edge connects two different vertices of the graph).
\end{definition}
